...
let Derpibooru = class Derpibooru extends website_base_1.Website {
    constructor() {
        super(...arguments);
        this.BASE_URL = 'https://derpibooru.org';
        this.MAX_CHARS = -1;
    ...
    validateFileSubmission(submission, submissionPart, defaultPart) {
        ...
        if (form_content_util_1.default.getTags(defaultPart.data.tags, submissionPart.data.tags).length < 3) {
