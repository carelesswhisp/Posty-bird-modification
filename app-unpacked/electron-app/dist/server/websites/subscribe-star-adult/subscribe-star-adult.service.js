...
exports.SubscribeStarAdult = void 0;
...
let SubscribeStarAdult = class SubscribeStarAdult extends website_base_1.Website {
    constructor() {
        super(...arguments);
        this.BASE_URL = 'https://www.subscribestar.adult';
    ...
    getDefaultOptions(submissionType) {
        if (submissionType === postybirb_commons_1.SubmissionType.FILE) {
            return postybirb_commons_1.WebsiteOptions.SubscribeStar.FileOptions;
        }
        return postybirb_commons_1.WebsiteOptions.SubscribeStar.NotificationOptions;
    }
    async checkLoginStatus(data) {
        const status = { loggedIn: false, username: null };
        const res = await http_util_1.default.get(this.BASE_URL, data._id, { updateCookies: false });
...
SubscribeStarAdult = __decorate([
    (0, common_1.Injectable)()
], SubscribeStarAdult);
exports.SubscribeStarAdult = SubscribeStarAdult;
